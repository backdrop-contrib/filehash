...
class FileHashConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['rehash'] = [
      ...
      '#description' => $this->t('If checked, always regenerate the hash when saving a file, even if the hash has been generated previously. This should be enabled if you have modules that modify files (e.g. core Image module with maximum image resolution set), and you want to keep the hash in sync with the file on disk. If disabled, only generate the hash if it is missing, which is much faster.'),
